...
/* TODO: 
// import { saveToHistory, getProductsWithSearch } from '@/redux/actions';
  */
...
export const SearchBar = (searchInitialValue) => {
    ...
    /* TODO: 
  Неисользуемая константа history
  */
    ...
    /* TODO: 
  Неиспользуемый аргумент event(+ принятое правило именования 'e'), + можно обьединить в функцию handleInputChange которая будет вешаться на Autocomplete (onInputChange={handleInputChange})
            ...
            <Autocomplete
                ...
                renderInput={(params) => (
                    <TextField
                        ...
                        /* TODO: 
              спред для избежания ошибок делаем первым
            */
                        {...params}
                        value={searchValue}
                        label="Search"

...
const SignUpPage = () => {
    /* TODO: 
 Вместо 8 useState лучше сделать один с объектом и им управлять.
  */
            ...
            <StyledPaper>
                ...
                <StyledForm onSubmit={handleRegister}>
                    ...
                    <Link to={APP_PATHS.SIGN_IN}>
                        <StyledSubmit type="button" fullWidth variant="contained" color="secondary">
                            Вернуться к логину
                        </StyledSubmit>
                    </Link>
                    <Snackbar
                    ...
                    >
                        <Alert onClose={handleRegistrationError} severity="error">
                            Ошибка регистрации
                        </Alert>
                    </Snackbar>
                </StyledForm>
